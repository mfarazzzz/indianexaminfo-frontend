...
export function TopBar() {
  return (
    <div className="bg-primary text-white text-sm h-9 flex items-center">
      <div className="container mx-auto px-4 flex items-center justify-between">
        <span className="hidden sm:block text-white/90 text-xs font-medium">
          {siteConfig.tagline}
        </span>
        <div className="flex items-center gap-4 ml-auto">
          {/* WhatsApp Channel */}
          <a href={siteConfig.whatsappChannel} target="_blank" rel="noopener noreferrer"
          ...
          {/* Telegram Channel */}
          <a href={siteConfig.telegramChannel} target="_blank" rel="noopener noreferrer"
